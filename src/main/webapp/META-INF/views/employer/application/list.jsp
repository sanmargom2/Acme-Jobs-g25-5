...
<acme:list>
	...
	<acme:list-column code="employer.application.list.label.worker" path="worker.authorityName" width="20%" />
	<acme:list-column code="employer.application.list.label.job" path="job.title" width="20%" />
</acme:list>